...
if __name__ == "__main__":
    ...
    # fasta_dir = '/gpfs/data/yarmarkovichlab/Frank/pan_cancer/atlas/COAD/db_fasta_tesorai'
    ...
    #     cmd += '{} '.format(fasta)
    # cmd += '> combined_COAD_pan_cancer.fasta'
    # subprocess.run(cmd,shell=True)
    # upload_single_file('combined_COAD_pan_cancer.fasta')