...
if __name__ == "__main__":
    ...
    fasta_dir = '/gpfs/data/yarmarkovichlab/Frank/pan_cancer/atlas/LUAD/db_fasta_tesorai'
    ...
    for fasta in all_combined_fasta:
        cmd += '{} '.format(fasta)
    cmd += '> combined_LUAD_pan_cancer.fasta'
    subprocess.run(cmd,shell=True)
    upload_single_file('combined_LUAD_pan_cancer.fasta')