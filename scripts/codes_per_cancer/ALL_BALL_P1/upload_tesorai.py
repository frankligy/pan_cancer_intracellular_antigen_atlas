...
if __name__ == "__main__":
    ...
    # immuno_dir = '/gpfs/data/yarmarkovichlab/Frank/pan_cancer/immunopeptidome/B_ALL'
    ...
    fasta_dir = '/gpfs/data/yarmarkovichlab/Frank/pan_cancer/atlas/ALL_BALL_P1/db_fasta_tesorai'
    ...
    for fasta in all_combined_fasta:
        cmd += '{} '.format(fasta)
    cmd += '> combined_ALL_BALL_P1_pan_cancer.fasta'
    subprocess.run(cmd,shell=True)
    upload_single_file('combined_ALL_BALL_P1_pan_cancer.fasta')